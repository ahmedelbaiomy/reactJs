...
const Search = () => {
    ...
    return (
        <div>
            ...
            <label>Search text
            <input name="searchText" className="form-control form-control-lg" type="text" onChange={onInputChange} value={searchText}/>
            </label>
            <br/>
            <br/>
            <label>Search type
            <input name="searchType" className="form-control form-control-lg" type="text" onChange={onInputChange} value={searchType}/>
            </label>
            <br/>
            <br/>
